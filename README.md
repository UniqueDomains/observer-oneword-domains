# Available .OBSERVER One-Word Domains (5,621,926)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C582%20rows-8250df">
...
> **Important:** this repository is a **public 9,582-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,926 domains** on the canonical page below.

**Public extract:** 9,582 rows · **Live catalog:** 5,621,926 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/observer?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_observer_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/observer?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_observer_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./observer.csv">CSV</a> / <a href="./observer.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_observer_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_observer_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .OBSERVER search](https://unique.domains/domains/tld/observer?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_observer_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .OBSERVER search](https://unique.domains/domains/tld/observer?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_observer_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./observer.csv) or [Download JSON](./observer.json)
...
- `observer.csv` — public CSV extract (9,582 rows)
- `observer.json` — public JSON extract (9,582 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,582-row public sample | 5,621,926 live domains                           |
...
| ------------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ----------- |
| seventeen.observer  | available | $15.99    | $15.99        | 84             | 62     | 9      | name.com    |
| fashion.observer    | resell    | —         | —             | 98             | 45     | 7      | Porkbun LLC |
| converse.observer   | premium   | $13       | $13           | 64             | 73     | 8      | namecheap   |
| athletics.observer  | available | $16.98    | —             | 69             | 52     | 9      | namecheap   |
| taco.observer       | resell    | —         | —             | 76             | 36     | 4      | Porkbun LLC |
| easy.observer       | premium   | $1,000    | $1,000        | 128            | 68     | 4      | name.com    |
| awake.observer      | available | $15.99    | —             | 86             | 39     | 5      | name.com    |
| graph.observer      | resell    | —         | —             | 92             | 32     | 5      | NAMECHEAP   |
| nationwide.observer | premium   | $1,000    | $1,000        | 76             | 66     | 10     | name.com    |
| goon.observer       | available | $15.99    | $15.99        | 80             | 36     | 5      | name.com    |
| patent.observer     | resell    | —         | —             | 96             | 27     | 6      | NAMECHEAP   |
| power.observer      | premium   | $1,040    | $1,040        | 98             | 64     | 5      | namecheap   |
| bread.observer      | available | $16.98    | —             | 102            | 33     | 5      | namecheap   |
| keen.observer       | resell    | —         | —             | 64             | 27     | 4      | Gandi SAS   |
| data.observer       | premium   | $1,040    | $1,040        | 70             | 60     | 4      | namecheap   |
...
| ethereal.observer   | available | $15.99    | $15.99        | 88             | 32     | 8      | name.com    |
...
> Unique Domains. *Available .OBSERVER One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
