...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C583%20rows-8250df">
...
> **Important:** this repository is a **public 9,583-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,926 domains** on the canonical page below.

**Public extract:** 9,583 rows · **Live catalog:** 5,621,926 domains
...
- `observer.csv` — public CSV extract (9,583 rows)
- `observer.json` — public JSON extract (9,583 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,583-row public sample | 5,621,926 live domains                           |
...
> Unique Domains. *Available .OBSERVER One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
